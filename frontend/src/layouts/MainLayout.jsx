...
const ICONS = {
  ...
  magasin: (
    <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0H5m14 0h2m-16 0H3m2 0h14M9 9h6m-6 4h6m-6 4h6M9 3v2m6-2v2" />
    </svg>
  ),
  supplier: (
    <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const NAV_ITEMS = [
  ...
  { to: "/magasins", label: "Magasins", icon: ICONS.magasin, profils: ["Administrateur", "Magasinier", "Gestionnaire"] },
  { to: "/fournisseurs", label: "Fournisseurs", icon: ICONS.supplier, profils: null },
